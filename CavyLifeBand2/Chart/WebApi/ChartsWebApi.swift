...
class ChartsWebApi: NetRequestAdapter {
    ...
    func parseSleepChartData(callBack: CompletionHandlernType? = nil) {
        ...
        let parameters: [String: AnyObject] = ["cmd": "getSleepInfo", "userId": CavyDefine.loginUserBaseInfo.loginUserInfo.loginUserId]
    ...
    func parseSleepChartsData(startDate: String? = "", endDate: String? = "", callBack: CompletionHandlernType? = nil) {
        ...
        let parameters: [String: AnyObject] = ["cmd": "getSleepInfo", "userId": CavyDefine.loginUserBaseInfo.loginUserInfo.loginUserId, "startDate": startDate!, "startDate": endDate!]
