//
//  HomeViewControllerParserExtension.swift
//  CavyLifeBand2
//
...
extension HomeViewController {
    ...
    /**
     ...
     没有时间：解析全部数据
     */
    private func parseStepDate(startDate: String, endDate: String) {
    ...
    /**
     ...
     没有时间：解析全部数据
     */
    private func parseSleepDate(startDate: String, endDate: String) {
     ...
     */
    private func addStepListRealm(list: StepMsg) {
    ...
    private func addSleepListRealm(list: SleepMsg) {
