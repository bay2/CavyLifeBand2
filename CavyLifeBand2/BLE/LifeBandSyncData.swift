...
enum LifeBandSyncDateError: ErrorType {
    case PacketNoError
}
...
class LifeBandSyncData {
     ...
     */
    func syncDataFormBand(date: NSDate, reslut: LifeBandSyncReslut<TitlsAndSteps, LifeBandSyncDateError> -> Void) {
...
//            
//            guard (self.packetNo + 1) == dataArray[3] else {
//                return
//            }
//            
//            self.packetNo += 1
//            
     ...
     */
    private func saveTiltsAndStepsData(dayCount: Int, data : NSData, reslut: LifeBandSyncReslut<TitlsAndSteps, LifeBandSyncDateError> -> Void) -> Bool {
        ...
        for i in 0..<data.length where i % 4 == 0  {
